...
class TestServices(TestCase):
    ...
    def test_goproteins(self):
        self.assertEqual(self.services.goproteins('GO:0009051'), ['O95336', 'P52209', 'P11413'])
        self.assertEqual(self.services.goproteins('GO:0009052'), ['P49247', 'Q2QD12', 'P29401', 'P37837', 'Q96AT9', 'Q9UHJ6'])
